...
const Layouts: React.FC = () => {
  ...
  const [loading, setLoading] = useState(permissions.length > 0 ? false : true);
  ...
  // menuRoutes不为空才返回menuItems
  const menuItems = menuRoutes && getMenuItems(menuRoutes, '', permissions);
